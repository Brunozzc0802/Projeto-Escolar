...
function VerificarNomeCompleto(const Nome: string): Boolean;
  var
...
function VerificarNumero(const Texto: string): Boolean;
  var
    Valor: Integer;
  begin
...
procedure TForm1.BotaoAdicionarClick(Sender: TObject);
  ...
  if not VerificarNomeCompleto(EditNome.Text) then
  begin
  ...
  if not VerificarNumero(EditCodigo.Text) then
  begin
...
procedure TForm1.btnAdicionarMouseEnter(Sender: TObject);
  begin
    BtnAdicionar.Color := clActiveCaption;
  end;

procedure TForm1.btnAdicionarMouseLeave(Sender: TObject);
  begin
...
procedure TForm1.btnListaDeEstudantesMenuAddClick(Sender: TObject);
  begin
    PainelAddEstudantes.Visible := False;
    PainelListaEstudantes.Visible := True;
  end;

procedure TForm1.btnListaDeEstudantesMenuAddMouseEnter(Sender: TObject);
  begin
    btnListaDeEstudantesMenuAdd.Color := clActiveCaption;
  end;
